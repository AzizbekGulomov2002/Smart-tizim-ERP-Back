    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tariff', models.CharField(choices=[('BASIC', 'Basic'), ('STANDART', 'Standart'), ('BEST', 'Best')], default='Best', max_length=20)),
                ('currency_type', models.CharField(help_text="Valyuta turini bering: So'm, Rubl, Dollar ...", max_length=200)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('DIRECTOR', 'director'), ('MANAGER', 'manager')], max_length=15)),
