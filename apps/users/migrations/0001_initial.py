    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet', models.IntegerField(default=0, verbose_name='qarzi haqqi')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('role', models.CharField(choices=[('COMPANY', 'company'), ('DIRECTOR', 'director'), ('MANAGER', 'manager'), ('KASSA', 'kassa'), ('STORAGE', 'storage')], max_length=15)),
